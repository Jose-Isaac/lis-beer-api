...
import com.lisbeer.application.store.StoreDetailsImp
...
class JWTStoreAuthenticationFilter(
    private val authManager: AuthenticationManager,
    private val jwtUtil: JWTUtil,
) : UsernamePasswordAuthenticationFilter() {

    init {
        setFilterProcessesUrl("/stores/signin")
    }
    ...
    override fun successfulAuthentication(
        ...
        val username = (authResult.principal as StoreDetailsImp).username
